...
| `0x05` | `REQ_ATTEST`                         | `RESP_ATTEST`                          |
| `0x06` | `REQ_HANDSHAKE` (sealed channel)     | `RESP_HANDSHAKE`                       |
| `0x07` | `REQ_ANNOUNCE` (operator identity)   | `RESP_ANNOUNCE`                        |
| `0x0A` | `REQ_GET_DB_PROOF`                   | `RESP_DB_PROOF`                        |
| `0x0B` | `REQ_SESSION_GRANT_PRESENT` (being retired) | `RESP_SESSION_GRANT_OK`         |
| `0x11` | `REQ_INDEX_BATCH` (DPF)              | `RESP_INDEX_BATCH`                     |
| `0x12` | `REQ_CREDIT_PRESENT` ([credits](/docs/sdk/payments); sealed channel only) | `RESP_CREDIT_OK` |
...
`0x04`, `0x08`, `0x09` and `0x0D`–`0x10` are retired (the residency
diagnostic and the earlier ARC / Cashu blind-auth and payment frames) and
